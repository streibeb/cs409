...
//
//  This constants has to be decalred outside the Vector2 class
...
//           of the corresponding components in this Vector2 and
//           other.
//  Side Effect: N/A
//
...
//           the corresponding components in this Vector2 and
//           other.
//  Side Effect: N/A
//
...
//           min, The new Vector2 contains min.  If the
...
//           corresponding componet of this Vector2, min, and
//           max.  If the component of this Vector2 is less than
//           the corresponing component of min, The new Vector2
...
//           the same direction as the specified Vector2, to
//           within about 0.0001 degrees (1.75e-6 radians).  To
//           be point in the same direction, 2 Vector2s must be
...
//           the specified Vector2, according to tolerance
//           VECTOR2_NORM_TOLERANCE.  Orthogonal is exactly the
...
//
	                      ...
	                      const Vector2& project_onto) const
	{
		...
		return operator-(getProjection(project_onto));
	}
...
//
	                      ...
	                      const Vector2& project_onto) const
	{
		...
		assert((operator-(projection)).isOrthogonal(project_onto));
		return operator-(getProjectionNormal(project_onto));
	}
