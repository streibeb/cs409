...
void World::drawSkybox(CoordinateSystem& camera)
{
    glPushMatrix();
...
void World::drawRings(CoordinateSystem& camera)
{
...
void World::calculateNearbySectors(Vector3 p)
{
...
int World::calculateSectorDensity(SectorId& sid)
{
...
double World::calculateDensityRing(Vector3& p)
{
...
double World::calculateDensityHoles(Vector3& p)
{
