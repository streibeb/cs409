...
#ifndef WORLD_EXPLOSIONS_H
#define WORLD_EXPLOSIONS_H
...
//    WorldExplosions must be loaded after GLUT is initialized
...
class WorldExplosions : public WorldInterface
{
public:
//
//  Default Constructor
//
//  Purpose: To create an WorldExplosions.
//  Parameter(s): N/A
//  Precondition(s): N/A
//  Returns: N/A
//  Side Effect: A new WorldExplosions is created.
//
...
//  Copy Constructor
//
//  Purpose: To create an WorldExplosions as a copy of another.
//  Parameter(s):
//    <1> original: The WorldExplosions to copy
//  Precondition(s): N/A
//  Returns: N/A
//  Side Effect: A new WorldExplosions is created containing the
//               same explosions as original.
//

	WorldExplosions (const WorldExplosions& original);

//
//  Destructor
//
//  Purpose: To safely destroy an WorldExplosions without memory
//           leaks.
//  Parameter(s): N/A
//  Precondition(s): N/A
//  Returns: N/A
//  Side Effect: All dynamically allocated memory associated
//               with this WorldExplosions is freed.
//

	virtual ~WorldExplosions ();

//
//  Assignment Operator
//
//  Purpose: To modify this WorldExplosions to be a copy of
//           another.
//  Parameter(s):
//    <1> original: The WorldExplosions to copy
//  Precondition(s): N/A
//  Returns: A reference to this WorldExplosions.
//  Side Effect: Any existing explosions are removed.  A copy of
//               each expliosion in original is added to this
//               WorldExplosions.
//

	WorldExplosions& operator= (
	                           const WorldExplosions& original);

//
//  isInitialized
//
//  Purpose: To determine if this WorldExplosions has been
//           initialized.
//  Parameter(s): N/A
//  Precondition(s): N/A
//  Returns: Whether this WorldExplosions is initialized.
//  Side Effect: N/A
//
...
//  draw
//
//  Purpose: To display everything in this WorldExplosionss.  In
...
//  init
//
//  Purpose: To initialize this WorldExplosions.
//  Parameter(s): N/A
//  Precondition(s): N/A
//  Returns: N/A
//  Side Effect: The ExplosionManager associated with this
//               WorldExplosions is initialized.  If this
//               WorldExplosions was laready initialized,
//               there is no effect.
//
...
//  reset
//
//  Purpose: To restore this WorldExplosions to its initial
//           initialized state.  In this implementation, this
//           means to remove all explosions.  This
//           WorldExplosions does not need to be initialized
//           again.
//  Parameter(s): N/A
//  Precondition(s):
//    <1> isInitialized()
...
//  updateAll
//
//  Purpose: To update everything in this WorldExplosions for
//           one frame.  In this implementation, there are only
//           explosions to update.
//  Parameter(s): N/A
//  Precondition(s):
//    <1> isInitialized()
//  Returns: N/A
...
//  Parameter(s): N/A
//  Precondition(s): N/A
//  Returns: The id for the planet.  This implementation always
//           returns PhysicsObjectId::ID_NOTHING.
//  Side Effect: N/A
//
...
//  Precondition(s):
//    <1> moon < getMoonCount()
//  Returns: The id for moon moon.  This implementation always
//           returns PhysicsObjectId::ID_NOTHING.
//  Side Effect: N/A
//
...
//           position.  This implementation always returns
...
//           thing is now dead.  This implementation always
//           returns false.
//  Side Effect: N/A
//
...
//    <2> isAlive(id)
//  Returns: Whether id identifies a moon.  This implementation
//           always returns zero.
//  Side Effect: N/A
//
...
//           id is a fighter.  This implementation always
//           returns false.
//  Side Effect: N/A
//
...
//    <1> id.m_type == PhysicsObjectId::TYPE_SHIP
//    <2> isAlive(id)
//  Returns: The maximum speed of ship id.  This implementation
//           always returns 1.0.
//  Side Effect: N/A
//
...
//    <1> id.m_type == PhysicsObjectId::TYPE_SHIP
//    <2> isAlive(id)
//  Returns: The maximum acceleration of ship id.  This
//           implementation always returns 0.0.
//  Side Effect: N/A
//
...
//           second.  This implementation always returns 0.0.
//  Side Effect: N/A
//
...
//    <1> id.m_type == PhysicsObjectId::TYPE_SHIP
//    <2> isAlive(id)
//  Returns: The current health of ship id.  This implementation
//           always returns 0.0.
//  Side Effect: N/A
//
...
//    <1> id.m_type == PhysicsObjectId::TYPE_SHIP
//    <2> isAlive(id)
//  Returns: The maximum health of ship id.  This function
//           always returns 1.0 in order to prevent divide-by-0
//           errors.
//  Side Effect: N/A
//
