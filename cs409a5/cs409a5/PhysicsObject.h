...
//
//  Class Invariant:
//    <1> m_id != PhysicsObjectId::ID_NOTHING
//    <2> m_radius >= 0.0
//    <3> m_speed >= 0.0
//    <4> mp_display_list == NULL || mp_display_list->isReady()
//    <5> m_display_scale >= 0.0
//
...
private:
	PhysicsObjectId m_id;
	CoordinateSystem m_coordinates;
	Vector3 m_position_previous;
	double m_radius;
	double m_speed;
	const DisplayList* mp_display_list;
