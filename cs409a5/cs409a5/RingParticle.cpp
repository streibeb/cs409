...
namespace
{
	...
	DisplayList ga_ring_particle_list;
...
void RingParticle :: load ()
{
	...
	ga_ring_particle_list = ObjModel("Models/RingParticleA0.obj").getDisplayListMaterialNone();
	assert(ga_ring_particle_list.isReady());
