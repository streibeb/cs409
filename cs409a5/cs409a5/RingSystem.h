...
public:
    ...
    //  Side Effect: N/A
    //
    bool handleRingParticleCollision(const Vector3& sphere_centre, double sphere_radius);
    ...
    //  Side Effect: N/A
    //
    std::vector<RingParticleData> getRingParticles(
