...
//    weird ones.
//
//  The texture path is prepended to texture filenames that are loaded.
//
//  To Do: Write a better class description.
//
...
//               The texture images are assumed to be in the
//               current folder.
//
...
//               (0.8, 0.8, 0.8), and a specular of
//               (1.0, 1.0, 1.0) and a specular exponent of 0.0.
//               The texture files are assumed to be in folder
//               texture_path.
//
...
//               this Material are loaded.  The current texture
//               path is prepended to each texture name as the
//               texture is loaded.
//
...
//               loaded.  The current texture path is prepended
//               to each texture name as the texture is loaded.
//
